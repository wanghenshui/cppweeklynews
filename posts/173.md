...
挂sanitize=address会报错。 https://godbolt.org/z/r4YsxvvM8

另外这个代码不挂sanitize**可能**会炸，我godbolt没复现 https://godbolt.org/z/TWxWcKoTd

- make_shared 无法访问私有构造？

使用friend tag绕过，非常猥琐 https://godbolt.org/z/xhzr6nE73
...
主要问题，aligned\_\*\_t 和 aligned\_\* 容易误用，漏掉**_t** 比如 https://godbolt.org/z/eEx1Pe94G
...
挺抽象 见 https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2021/p1413r3.pdf
...
代码就不贴了，看godbolt https://godbolt.org/z/8P3MfvcKb
