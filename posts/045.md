...
之前也说过，比如**[Deducing `this`](https://wg21.link/p0847/github)**，比如多维数组 operator , auto代替decay_copy ，123uz后缀 stack_trace库,加强的optional，move_only_function(function_ref), string的细致支持 resize_and_overwrite
